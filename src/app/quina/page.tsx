...
import { generateQuinaGames, QuinaSimulationResult } from "@/utils/quina";

export default function QuinaPage() {
    const [selectedNumbers, setSelectedNumbers] = useState<number[]>([]);
    const [result, setResult] = useState<QuinaSimulationResult | null>(null);
    ...
    const handleGenerate = () => {
        if (selectedNumbers.length === 5) {
            try {
                const res = generateQuinaGames(selectedNumbers);
                setResult(res);
            } catch (e) {
        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 verde:bg-[#022c22] text-zinc-900 dark:text-zinc-100 verde:text-emerald-50 font-sans selection:bg-blue-500/30 pb-20 transition-colors duration-500">
            ...
            <header className="pt-8 pb-8 px-6 flex flex-col items-center relative">
                ...
                <p className="mt-4 text-blue-800/60 dark:text-blue-200/50 verde:text-blue-200/70 max-w-lg mx-auto text-lg leading-relaxed text-center">
                    Selecione os 5 números sorteados do último concurso para simular os fechamentos avançados.
                </p>
            </header>
                ...
                {result && (
                    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                        ...
                        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white/40 dark:bg-zinc-900/30 verde:bg-emerald-900/20 backdrop-blur-md rounded-3xl p-6 border border-blue-100 dark:border-blue-900/30 verde:border-blue-800/50 h-full">
                                <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 verde:text-blue-300 mb-6 flex items-center">
                                    ...
                                    Análise das Sorteadas (5)
                                </h3>

                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 verde:text-emerald-400/70 uppercase tracking-wider mb-3">Fixas Sorteadas (1)</h4>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-white dark:bg-zinc-900/50 verde:bg-emerald-800/30 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800 verde:border-emerald-700/30">
                                            <h4 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 verde:text-emerald-400/70 uppercase tracking-wider mb-3">Grupo A Base (2)</h4>
                                            <div className="flex flex-wrap gap-2">
                                        ...
                                        <div className="bg-white dark:bg-zinc-900/50 verde:bg-emerald-800/30 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800 verde:border-emerald-700/30">
                                            <h4 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 verde:text-emerald-400/70 uppercase tracking-wider mb-3">Grupo B Base (2)</h4>
                                            <div className="flex flex-wrap gap-2">
                            ...
                            <div className="bg-white/40 dark:bg-zinc-900/30 verde:bg-emerald-900/20 backdrop-blur-md rounded-3xl p-6 border border-red-100 dark:border-red-900/30 verde:border-emerald-800/50 h-full">
                                <h3 className="text-xl font-bold text-red-500 dark:text-red-400 verde:text-red-300 mb-6 flex items-center">
                                    ...
                                    Análise das Não Sorteadas (75)
                                </h3>

                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 verde:text-emerald-400/70 uppercase tracking-wider mb-3">Fixas Não Sorteadas (1)</h4>
                                        <div className="flex flex-wrap gap-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-white dark:bg-zinc-900/50 verde:bg-emerald-800/30 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800 verde:border-emerald-700/30">
                                            <h4 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 verde:text-emerald-400/70 uppercase tracking-wider mb-3">Grupo R3 Base (1)</h4>
                                            <div className="flex flex-wrap gap-2">
                                        ...
                                        <div className="bg-white dark:bg-zinc-900/50 verde:bg-emerald-800/30 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800 verde:border-emerald-700/30">
                                            <h4 className="text-xs font-semibold text-zinc-500 dark:text-zinc-400 verde:text-emerald-400/70 uppercase tracking-wider mb-3">Grupo R4 Base (1)</h4>
                                            <div className="flex flex-wrap gap-2">
                        ...
                        <section className="space-y-6">
                            <h2 className="text-3xl font-extrabold text-center mb-10 verde:text-blue-100">4 Apostas Geradas (Quina)</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {[
                                    ...
                                    <div key={i} className="bg-gradient-to-br from-white to-zinc-50 dark:from-zinc-900 dark:to-black verde:from-sky-900 verde:to-blue-950 rounded-3xl p-6 md:p-8 shadow-xl border border-zinc-200/50 dark:border-zinc-800/80 verde:border-blue-800/50 hover:scale-[1.02] transition-transform duration-300">
                                        <div className="flex justify-between items-center mb-6 border-b border-zinc-100 dark:border-zinc-800 verde:border-blue-800/50 pb-4">
                                            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-zinc-500 dark:from-white dark:to-zinc-400 verde:from-blue-200 verde:to-blue-400">
                                                {jogo.title}
                                            </h3>
                                            <span className="text-xs font-bold px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 verde:bg-blue-800/50 text-zinc-500 dark:text-zinc-400 verde:text-blue-300">
                                        ...
                                        <div className="flex flex-wrap gap-2 md:gap-3">
                                            {jogo.nums.map(n => {
                                                ...
                                                if (isSortFixa || isNaoSortFixa) {
                                                    colorClass = "bg-gradient-to-br from-indigo-400 to-indigo-600 border-none text-white shadow-md shadow-indigo-500/20 verde:shadow-indigo-900/30";
                                                } else if (isSorteada) {
